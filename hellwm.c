		...
		if (!output_configuration_head->state.enabled)
      {
		...
		if (output_configuration_head->state.mode)
			...
			wlr_output_state_set_custom_mode(
               &state,
					output_configuration_head->state.custom_mode.width,
					output_configuration_head->state.custom_mode.height,
					output_configuration_head->state.custom_mode.refresh);
